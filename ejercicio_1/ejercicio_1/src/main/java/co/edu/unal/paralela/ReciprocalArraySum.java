...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            ...
            if (length <= 1000) {  // umbral para calcular secuencialmente
                double sum = 0;
    ...
    /**
     * Modificar este método para calcular la suma de recíprocos usando dos tareas en paralelo.
     * Se asume que el largo del arreglo es divisible por 2.
     *
     * @param input Arreglo de entrada
     * @return La suma de los recíprocos del arreglo de entrada
     */
    protected static double parArraySum(final double[] input) {
        ...
        ReciprocalArraySumTask mainTask = new ReciprocalArraySumTask(0, input.length, input);
    ...
    /**
     * Implementa la suma de recíprocos utilizando un número arbitrario de tareas.
     *
     * @param input Arreglo de entrada
     * @param numTasks Número de tareas
     * @return La suma de los recíprocos del arreglo de entrada
     */
