        ...
        for (int ii = 0; ii < tasks; ii++) {
            ...
            threads[ii] = new Thread(() -> {
                ...
                for (int iter = 0; iter < iterations; iter++) {
                    ...
                    // Usar arrive() para señalar que terminamos el trabajo computacional
                    // pero no esperar inmediatamente
                    int phase = ph.arrive();
                    
                    // Hacer el intercambio de arreglos mientras otras tareas pueden estar
                    // aún trabajando - esto es la clave del fuzzy barrier
                    double[] temp = threadPrivateMyNew;
                    threadPrivateMyNew = threadPrivateMyVal;
                    threadPrivateMyVal = temp;
                    
                    // Solo ahora esperar a que todas las tareas terminen
